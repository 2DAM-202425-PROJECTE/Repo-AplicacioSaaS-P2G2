<template>
    <layout>
        <div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg flex border border-gray-200">
            <!-- Sidebar de Filtres -->
            ...
            <div class="w-3/4 pl-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Link v-for="restaurant in filteredRestaurants" :key="restaurant.id" :href="`/restaurants/${restaurant.id}`"
...
<!-- Afegir Font Awesome + Colors Personalitzats -->
<style>
